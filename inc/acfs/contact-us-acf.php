...
e.g. estates@lincoln.ac.uk',
		...
		array(
			'key' => 'field_5b7c0dd99a88a',
			'label' => 'E-mail Tracking Link',
			'name' => 'e-mail_tracking_link',
			'type' => 'text',
			'instructions' => 'If this particular email link needs a tracking URL, paste that here...',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
